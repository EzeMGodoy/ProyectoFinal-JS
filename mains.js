...
const setCarrito = objeto => { //Cuando hago click, selecciono todos los elementos de la card y los empujo dentro de setCarrito y generar ese objeto
    ...
    if(carrito.hasOwnProperty(producto.id)) { //si existe queire decir que el producto se está duplicando por lo tanto agregar 1 mas
...
const pintarCarrito = () => {
    ...
    Object.values(carrito).forEach(producto => { //! Uso Object.values, porque al ser un objeto NO le puedo pasar metodos de arrays. Con esta propiedad si.
